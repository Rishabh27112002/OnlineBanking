...
<h2>Debit Amount</h2>
<form name="frm"method="GET" action="debit.php">
<table >
<tr><td>Date: </td><td><input type="date" name="t2"id="demo"/></td></tr>
<tr><td>Enter amount to debit</td><td><input type="number" name="t3" size="20"></td></tr>
<tr><td>debited by</td><td><input type="text" name="t5" size="30"></td></tr>
